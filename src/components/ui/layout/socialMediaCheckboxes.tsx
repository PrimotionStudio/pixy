            ...
            {socialMediaAccounts.map((account) => {
                ...
                return (
                    <div
                        ...
                        className={`relative w-10 h-10 p-1 flex items-center justify-center rounded-full cursor-pointer transition-transform transform ${isSelected ? "scale-110" : "scale-100"
                            }`}
                        style={{
